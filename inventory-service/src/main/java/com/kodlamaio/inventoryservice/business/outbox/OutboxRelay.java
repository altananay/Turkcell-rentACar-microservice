...
public class OutboxRelay {
    ...
    private static final Map<String, Class<? extends Event>> TOPIC_TYPES = Map.of(
            "car-created", CarCreatedEvent.class,
            "car-deleted", CarDeletedEvent.class,
            "brand-deleted", BrandDeletedEvent.class);
    ...
    public void publishPending() {
        for (var message : repository.findTop100ByPublishedFalseOrderByCreatedAtAsc()) {
            ...
            try {
                ...
                // single shared scheduler thread, which would starve every other @Scheduled job.
