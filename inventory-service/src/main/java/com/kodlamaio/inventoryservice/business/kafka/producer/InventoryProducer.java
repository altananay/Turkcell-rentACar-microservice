...
public class InventoryProducer {
    ...
    public void sendMessage(CarCreatedEvent event)
    {
        ...
        Message<CarCreatedEvent> message = MessageBuilder.withPayload(event).setHeader(KafkaHeaders.TOPIC, "car-created").build();
    ...
    public void sendMessage(CarDeletedEvent event)
    {
        ...
        Message<CarDeletedEvent> message = MessageBuilder.withPayload(event).setHeader(KafkaHeaders.TOPIC, "car-deleted").build();
        kafkaTemplate.send(message);
    }
